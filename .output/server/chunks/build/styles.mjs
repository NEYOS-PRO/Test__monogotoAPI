...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./entry-styles.D8RRNuZP.mjs').then(interopDefault),
  "pages/index.vue": () => import('./index-styles.Da9yJUhW.mjs').then(interopDefault),
